...
% tau     - time-step of the dual ascent ( pick 0 for noise-slack ) 双重上升的时间步长（为零噪声选择0）
% K       - the number of modes to be recovered 要恢复的模式数
% DC      - true if the first mode is put and kept at DC (0-freq) 如果将第一个模式置于并保持为直流（0频率），则为true
% init    - 0 = all omegas start at 0   所有的omegas 都从0开始
%                    1 = all omegas start uniformly distributed 所有的omegas开始均匀分布
%                    2 = all omegas initialized randomly  随机
% tol     - tolerance of convergence criterion; typically around 1e-6
%
% Output:
% -------
% u       - the collection of decomposed modes 分解模式的集合
% u_hat   - spectra of the modes 模式的谱
